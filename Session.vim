...
set shortmess=aoO
badd +183 ~/workspace/Android_Texun99/jni/dot.c
args ~/workspace/Android_Texun99/\[BufExplorer]
edit ~/workspace/Android_Texun99/jni/dot.c
...
let s:l = 119 - ((27 * winheight(0) + 24) / 49)
