...
set modelines=0
set mouse=a
set path=.,/usr/include,,,res/layout,res/layout-finger,res/values,res/drawable,res/drawable-mdpi,/System/Library/Frameworks/OpenGL.framework/Headers,~/program/android-ndk-r8c/platforms/android-9/arch-arm/usr/include,assets
set ruler
...
set suffixesadd=.java,.xml,.9.png,.png,.glsl
set noswapfile
...
set shortmess=aoO
badd +98 ~/workspace_tb/Android_Texun99/jni/dot.c
silent! argdel *
...
setlocal suffixesadd=.java,.xml,.9.png,.png,.glsl
setlocal noswapfile
...
let s:l = 113 - ((20 * winheight(0) + 14) / 28)
