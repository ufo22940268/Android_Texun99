...
set shortmess=aoO
badd +170 ~/workspace/Android_Texun99/jni/render.c
silent! argdel *
edit ~/workspace/Android_Texun99/jni/render.c
...
let s:l = 152 - ((15 * winheight(0) + 24) / 49)
